...
// ***********************************************************************
// <copyright file="SqlExpressionVisitor.cs" company="Noob.Core">
...
namespace Noob.Expressions
{
    ...
    public class SqlExpressionVisitor
    {
        ...
        /// <exception cref="Exception">Unhandled expression type: "+exp.NodeType</exception>
        ...
        /// <exception cref="Exception">Unhandled binding type :"+binding.BindingType</exception>
