...
// ***********************************************************************
// <copyright file="RecyclableMemoryStream.cs" company="Noob.Core">
...
namespace Noob.Text //Internalize to avoid conflicts
{
    ...
    {
        /// <summary>
        /// Gets or sets a value indicating whether [use recyclable memory stream].
        /// </summary>
        /// <value><c>true</c> if [use recyclable memory stream]; otherwise, <c>false</c>.</value>
    ...
    public partial class RecyclableMemoryStreamManager
    {
        ...
        /// <summary>
        /// The default large buffer multiple
        /// </summary>
        ...
        /// </summary>
        /// <value><c>true</c> if [generate call stacks]; otherwise, <c>false</c>.</value>
        ...
        /// be valid).
        /// </summary>
        /// <value><c>true</c> if [aggressive buffer return]; otherwise, <c>false</c>.</value>
        ...
        /// <summary>
        /// Rounds to large buffer multiple.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether [is large buffer multiple] [the specified value].
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns><c>true</c> if [is large buffer multiple] [the specified value]; otherwise, <c>false</c>.</returns>
    ...
    /// buffers.
    /// Implements the <see cref="System.IO.MemoryStream" />
    /// </summary>
    ...
    /// are maintained in the stream until the stream is disposed (unless AggressiveBufferReturn is enabled in the stream manager).</remarks>
    public sealed class RecyclableMemoryStream : MemoryStream
    {
        ...
        /// allow stream truncation.</remarks>
        ...
        /// or
        /// value - value cannot be more than " + MaxStreamLength
        /// </exception>
        /// <exception cref="ObjectDisposedException">Object has been disposed</exception>
        ...
        /// <exception cref="ObjectDisposedException">buffer is null</exception>
        ...
        /// </summary>
        /// <param name="offset">The offset.</param>
        /// <returns>BlockAndOffset.</returns>
        ...
        /// <exception cref="InvalidOperationException">Requested capacity is too large: " + newCapacity + ". Limit is " + this.memoryManager.MaximumStreamCapacity</exception>
    ...
    public sealed partial class RecyclableMemoryStreamManager
    {
        ...
        /// <summary>
        /// Class Events. This class cannot be inherited.
        /// </summary>
        public sealed class Events// : EventSource
        {
            ...
            /// <summary>
            /// Enum MemoryStreamDiscardReason
            /// </summary>
            ...
            /// <summary>
            /// Memories the stream double dispose.
            /// </summary>
            /// <param name="guid">The unique identifier.</param>
            /// <param name="tag">The tag.</param>
            /// <param name="allocationStack">The allocation stack.</param>
            /// <param name="disposeStack1">The dispose stack1.</param>
            /// <param name="disposeStack2">The dispose stack2.</param>
            ...
            /// <summary>
            /// Memories the stream manager initialized.
            /// </summary>
            /// <param name="blockSize">Size of the block.</param>
            /// <param name="largeBufferMultiple">The large buffer multiple.</param>
            /// <param name="maximumBufferSize">Maximum size of the buffer.</param>
            ...
            /// <summary>
            /// Memories the stream new block created.
            /// </summary>
            ...
            /// <summary>
            /// Memories the stream new large buffer created.
            /// </summary>
            /// <param name="requiredSize">Size of the required.</param>
            ...
            /// <summary>
            /// Memories the stream non pooled large buffer created.
            /// </summary>
            /// <param name="requiredSize">Size of the required.</param>
            /// <param name="tag">The tag.</param>
            /// <param name="allocationStack">The allocation stack.</param>
            ...
            /// <summary>
            /// Memories the stream discard buffer.
            /// </summary>
            ...
            /// <summary>
            /// Memories the stream over capacity.
            /// </summary>
